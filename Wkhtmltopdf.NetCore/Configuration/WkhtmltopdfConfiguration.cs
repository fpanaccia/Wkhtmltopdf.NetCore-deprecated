...
namespace Wkhtmltopdf.NetCore
{
    public static class WkhtmltopdfConfiguration
    {
        ...
        /// <param name="wkhtmltopdfRelativePath">Optional. Relative path to the directory containing wkhtmltopdf.
        /// Default is "Rotativa". Download at https://wkhtmltopdf.org/downloads.html</param>
        [Obsolete]
